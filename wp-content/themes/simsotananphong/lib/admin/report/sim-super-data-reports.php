 ...
 */
function _n_get_sim_super_data_reports(){
	...
	<table class="widefat striped" id="sim-report-table">
		...
		if ($loop->have_posts()):
			while ($loop->have_posts()) : $loop->the_post();
				...
				$sim          = wc_get_product($sim_id);
				$so_thue_bao  = $sim->get_name();
...
add_action('wp_ajax_sim_super_data_report', '_n_get_sim_super_data_reports');
